...
namespace DBDcoumentCreater
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            cbbFileType.SelectedIndex = ini.GetInt32("Set", "index", 0);
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            var del = new ThreadStart(ExportCHM);
            if (cbbFileType.Text.ToUpper() == "PDF")
            {
                lblMessage.Text = "暂时不支持PDF格式的导出";
            }

            if (cbbFileType.Text.ToUpper() == "HTML")
            {
                del = new ThreadStart(ExportHTML);
            }
        ...
        {
            System.Windows.Forms.DialogResult result = fbdSelect.ShowDialog();
            if (result == System.Windows.Forms.DialogResult.OK)
            {
                this.fileSaveDirectory = fbdSelect.SelectedPath;
            }
